...
pheatmap(dataHeat, cluster_cols = FALSE, annotation_col = annotation_col, annotation_colors = annotation_colors, labels_col = targets$groups, labels_row = labels_row, annotation_legend = FALSE, fontsize_row = 8, gaps_col = cumsum(table(targets$groups)), breaks =  seq(from = -3, to = 3, length.out = 101), legend_breaks = seq(from = -3, to = 3, by = 2), main = "Niche binding", clustering_method = "single")



dataHeat <- exprNorm2[intrProbes, ]
...
### Plot of expression scaled per gene 
pheatmap(dataHeat, cluster_cols = FALSE, annotation_col = annotation_col, annotation_colors = annotation_colors, labels_col = targets$groups, labels_row = labels_row, annotation_legend = FALSE, fontsize_row = 8, gaps_col = cumsum(table(targets$groups)), breaks =  seq(from = -3, to = 4, length.out = 101), legend_breaks = seq(from = -3, to = 3, by = 2), main = "Niche binding", clustering_method = "single")
...
intrGenes <- read.table("Gene_Sets/niche_interaction_genes_v2_niche_formation.csv", header = TRUE, sep = ",")
intrProbes <- as.character(intrGenes$ProbesetID)
...
### Plot of expression scaled per gene
pheatmap(dataHeat, cluster_cols = FALSE, annotation_col = annotation_col, annotation_colors = annotation_colors, labels_col = targets$groups, labels_row = labels_row, annotation_legend = FALSE, fontsize_row = 8, gaps_col = cumsum(table(targets$groups)), breaks =  seq(from = -3, to = 3, length.out = 101), legend_breaks = seq(from = -3, to = 3, by = 2), main = "Niche formation", clustering_method = "single")
...
### Plot of expression scaled per gene
pheatmap(dataHeat, cluster_cols = FALSE, annotation_col = annotation_col, annotation_colors = annotation_colors, labels_col = targets$groups, labels_row = labels_row, annotation_legend = FALSE, fontsize_row = 8, gaps_col = cumsum(table(targets$groups)), breaks =  seq(from = -3, to = 4, length.out = 101), legend_breaks = seq(from = -3, to = 3, by = 2), main = "Niche formation", clustering_method = "single")
