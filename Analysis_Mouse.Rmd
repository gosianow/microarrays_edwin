...
Compare leukemia samples versus different controls: CD4+, CD4+CD8+ and CD8+ and bone marrow.
...
```{r Comp1_plots, fig.width = 11, fig.height = 11}
par(mfrow=c(2,2))
...
```{r Comp1_plotExpr, fig.width = 11, fig.height = 11}
...
## Clustering all genes based on DE results

```{r Comp1_clustering_heatmap, fig.width = 7, fig.height = 11}
...
```{r Comp1_GO_clus, results = "hide", eval = FALSE}
...
## GO analysis per control samples (up and down-regulated genes separetely) 

```{r Comp1_GO_sampUpDown, results = "hide", eval = FALSE}
...
## GO analysis per control samples (up and down-regulated genes together)

```{r Comp1_GO_samp, results = "hide", eval = FALSE}
